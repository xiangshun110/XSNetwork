...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'http://nasxs.cn:32769/xiangshun/XSNetwork'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shun' => '113648883@qq.com' }
  s.source           = { :git => 'http://nasxs.cn:32769/xiangshun/XSNetwork.git', :tag => s.version.to_s }
